...
The {{site_name}} Team`,
    ...
    testVars: {
      ...
      inbox_url: "https://lanelogicjobs.com/dashboard/messages",
      site_name: "LaneLogic Jobs",
    },
    triggerType: "event",
...
{{site_url}}`,
    ...
    testVars: {
      ...
      job_title: "CDL A Driver – OTR",
      expiry_date: "April 1, 2025",
      renew_url: "https://lanelogicjobs.com/dashboard/jobs",
      dashboard_url: "https://lanelogicjobs.com/dashboard",
      site_name: "LaneLogic Jobs",
      site_url: "https://lanelogicjobs.com",
    },
...
{{site_url}}`,
    ...
    testVars: {
      ...
      profile_url: "https://lanelogicjobs.com/dashboard/profile",
      site_name: "LaneLogic Jobs",
      site_url: "https://lanelogicjobs.com",
    },
    triggerType: "scheduled",
