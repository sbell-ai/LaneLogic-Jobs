...
export default function Resources() {
  ...
  const accessible = (resources || []).filter((r) => canAccess(user?.membershipTier, r.requiredTier));
  const locked = (resources || []).filter((r) => !canAccess(user?.membershipTier, r.requiredTier));
