      ...
      <main className="flex-grow bg-slate-50 dark:bg-slate-950 py-10">
        <div className="container mx-auto px-4 md:px-6 max-w-3xl">
          ...
          <article className="bg-white dark:bg-slate-900 rounded-2xl border border-border shadow-sm overflow-hidden">
            <div className="h-52 bg-gradient-to-br from-primary/10 via-primary/5 to-accent/10 flex items-center justify-center">
              <Newspaper className="text-primary/30" size={72} />
            </div>
            <div className="p-8">
              ...
              <h1 className="text-3xl font-bold font-display mb-6">{post.title}</h1>
